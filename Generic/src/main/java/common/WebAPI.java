...
import java.util.concurrent.TimeUnit;
    ...
    public class WebAPI {
        ...
        @BeforeMethod
        public void setUp(@Optional("false") boolean useCloudEnv, @Optional("sauceLabs") String cloudEnvName, @Optional("windows") String OS, @Optional("10") String os_version, @Optional("firefox") String browserName, @Optional("106") String browserVersion, @Optional("https://www.google.com/") String url) throws IOException {
        ...
        public WebDriver getLocalDriver(String OS, String browserName) {
            if (browserName.equalsIgnoreCase("chrome")) {
                ...
                if (OS.equalsIgnoreCase("OS X")) {
                    System.setProperty("webdriver.chrome.driver", "/Users/mohammadaziz/eclipse-workspace/WAF_1st_sep_21/Generic/BrowserDriver/chromedriver");
                } else if (OS.equalsIgnoreCase("windows")) {
                    System.setProperty("webdriver.chrome.driver", "../Generic/BrowserDriver/windows/chromedriver.exe");
                }
                ...
                if (OS.equalsIgnoreCase("OS X")) {
                    System.setProperty("webdriver.gecko.driver", "/Users/mohammadaziz/eclipse-workspace/WAF_1st_sep_21/Generic/BrowserDriver/geckodriver");
                } else if (OS.equalsIgnoreCase("windows")) {
